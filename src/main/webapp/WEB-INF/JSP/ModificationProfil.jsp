	...
	<div class="container">
		...
		<div class="row justify-content-md-center">
			...
			<form action="${pageContext.request.contextPath}/ModificationProfil"
				...
				<input id="ModifPseudo" pattern="[a-zA-Z0-9]{3,20}" 
				value="${Utilisateur.pseudo}" name="pseudo">
				
				<br>
				
				<label id="signUpNomLabel">Nom : </label>
				<input id="ModifNom" type="text" name="nom" value="${Utilisateur.nom}">
				
				<br>
				
				<label id="signUpPrenomLabel">Prenom : </label>
				<input id="ModifPrenom" type="text" name="prenom" value="${Utilisateur.prenom}">
				
				<br>
				<label id="signUpEmailLabel">Email : </label>
				<input id="ModifEmail" type="email" name="email" value="${Utilisateur.email}">
				...
				<input id="ModifRue" type="text" name="rue" value="${Utilisateur.rue}">
				...
				<input id="ModifVille" type="text" name="ville" value="${Utilisateur.ville}">
				...
				<input id="ModifNewMdp" type="password" name="newMdp" placeholder="********"
					pattern="^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[-+!*$@%_])([-+!*$@%_\w]{8,15})$">
				...
				<input id="ModifCrédit" value="${Utilisateur.credit}" readonly="readonly">
				
				<div class="ModifProfilButtons">
					<input id="inscriptionButton" class="btn btn-primary"
						id="ModifSaveButton" type="submit" value="Enregistrer">
