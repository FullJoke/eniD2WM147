...
<body>
	<form action="" methode="post">
		...
		<input id="signUpPseudo" pattern="[A-z0-9]"	type="text" name="pseudo" placeholder="Invite01" >
		<br>
		...
		<input id="signUpEmail"	type="text" name="email" placeholder="martin.camille@fakemail.com">
		<br>
				
		<label id="signUpTelephoneLabel">Telephone : </label> 
		<input id="signUpTelephone" pattern="^0[0-9]{9}" type="text" name="tel" placeholder="01 02 03 04 05">
		<br>
		...
		<input id="signUpCodePostal"	type="text" name="codePostal" placeholder="11111">
		<br>
		...
		<input id="signUpMdp"	type="password" name="mdp" placeholder="********">
		<br>
		
		<label id="signUpConfirmationLabel">Confirmation : </label> 
		<input id="signUpConfirmation"	type="password" name="confirmation" placeholder="********" >
		<br>
		
	</form>
	<input id="signUpOKButton" type="submit" value="Valider" >
	<input id="loginWithdrawButton" type="submit" value="Annuler">
