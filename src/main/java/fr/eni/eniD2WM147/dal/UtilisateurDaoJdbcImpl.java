...
public class UtilisateurDaoJdbcImpl implements UtilisateurDAO {
    ...
    private static final String SELECT_BY_ENCHERE = "SELECT * FROM ENCHERES e JOIN UTILISATEURS u "            + "ON e.no_utilisateur=u.no_utilisateur WHERE no_article = ?";
    ...
    @Override    public Utilisateur updateUserProfil(String pseudo, String nom, String prenom, String email, String tel, String rue,
        ...
        try (Connection cnx = ConnectionProvider.getConnection()) {
            ...
            // pas bon car id à 0            System.out.println("id utilisateur" + idUtilisateur);
            pstmt.executeUpdate();
